    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="/Users/home">queueworker-批量任务处理平台</a>
            </div>
            <!-- /.navbar-header -->
                    ...
                    <ul class="nav" id="side-menu">
                        <li class="sidebar-search">
                            <div class="input-group custom-search-form">
                                <input type="text" class="form-control" placeholder="功能检索">
                        ...
                        <li>
                            <a href="/Users/home"><i class="fa fa-dashboard fa-fw"></i> 控制面板</a>
                        </li>
                        <li>
